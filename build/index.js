...
var tailwind_default = "/build/_assets/tailwind-XBIBC6HY.css";
...
async function createUser(email, password) {
  let hashedPassword = await import_bcryptjs.default.hash(password, 10), { data, error } = await supabase.auth.admin.createUser({
    email,
  ...
  let { data2, error2 } = await supabase.storage.from("files").upload(user.id + "/.initial", "", {
    cacheControl: "3600",
    upsert: !1
  });
  return console.log("data2:", data2), user;
}
...
function EditNotePage() {
  ...
  let data = (0, import_react3.useLoaderData)(), actionData = (0, import_react3.useActionData)(), idRef = React.useRef(null), titleRef = React.useRef(null), bodyRef = React.useRef(null), imageRef = React.useRef(null), noimageRef = React.useRef("false"), [file, setfile] = (0, import_react4.useState)([]), [db_fileName, db_setFileName] = (0, import_react4.useState)([]), submit = (0, import_react_router_dom.useSubmit)();
  React.useEffect(() => {
    var _a2, _b2, _c2, _d2;
  ...
  let handleFileSelected = (e) => {
    ...
    if (formData.set("id", idRef.current.value), formData.set("title", titleRef.current.value), formData.set("body", bodyRef.current.value), formData.set("noimage", noimageRef.current.checked), file.length !== 0) {
      let filename = `${(0, import_uuid.v4)()}-${file.name}`, { data: data2, error } = await supabase2.storage.from("files").upload(filename, file, {
        cacheControl: "3600",
        upsert: !1
      }), filepath = data2.path;
...
function NoteDetailsPage() {
  let data = (0, import_react5.useLoaderData)(), CDNURL2 = "", navigate = (0, import_react6.useNavigate)();
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "bg-dark text-slate-50", children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("h3", { className: "text-2xl font-bold", children: data.note.title }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { className: "py-6", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("pre", { children: data.note.body }) }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { className: "py-6", children: data.note.img && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("img", { src: `${data.note.img}`, alt: "dd", style: { width: "100px" } }) }),
...
var import_react7 = require("react"), import_react_bootstrap = require("react-bootstrap"), import_Button2 = __toESM(require("react-bootstrap/Button")), import_supabase_js3 = require("@supabase/supabase-js"), import_node6 = require("@remix-run/node"), import_react8 = __toESM(require("react")), import_uuid2 = require("uuid");
...
function imagemanager() {
  ...
  let handleFileSelected = (e) => {
    ...
    let { data: data2, error } = await supabase5.storage.from(bucket).list(target, {
      limit: 100,
      offset: 0,
      sortBy: { column: "name", order: "asc" }
    });
    console.log(data2), setFilesData(data2);
  }, handleSubmit = async (e) => {
    e.preventDefault();
    let filename = `${(0, import_uuid2.v4)()}-${file.name}`, { data: data2, error } = await supabase5.storage.from(bucket).upload(user + "/" + url + "/" + filename, file, {
      cacheControl: "3600",
      upsert: !1
    });
    ...
    let origem = bb[0] == "/" ? user + bb : user + "/" + bb, destino = cc[0] == "/" ? user + cc : user + "/" + cc, { data: data2, error } = await supabase5.storage.from(bucket).move(origem, destino);
    console.log(error), setShowRenomear(!1), setUrl(cc);
  }, newFolder = async (name) => {
    let { data: data2, error } = await supabase5.storage.from(bucket).upload(user + "/" + url + "/" + name + "/.initial", "", {
      cacheControl: "3600",
      upsert: !1
    });
    list_files("", url);
    ...
    if (console.log("::", user + url + "/*"), confirm("Confirma exclus\xE3o da pasta:" + url)) {
      let { data: data2, error } = await supabase5.storage.from(bucket).remove([user + "/" + url + "/.initial"]);
      console.log(data2, error), error ? alert(error) : back();
    }
  }, deleteImage = async (imageName) => {
    if (console.log(imageName), confirm("Confirma exclus\xE3o do arquivo:" + imageName)) {
      let { data: data2, error } = await supabase5.storage.from(bucket).remove([user + url]);
      console.log(data2, error), error ? alert(error) : back();
    }
  }, copy = async () => {
    ...
    let { data: data2, error } = await supabase5.storage.from(bucket).copy(user + "/" + folderCopyAction, user + "/" + url);
    ...
    let { data: data2, error } = await supabase5.storage.from(bucket).copy(user + fileCopyAction, user + "/" + url + "/" + fileName);
    ...
    let { data: data2, error } = await supabase5.storage.from(bucket).move(user + selectFile, user + "/" + url + "/" + fileName);
    console.log(error), setSelectFile(""), list_files("", url);
  };
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: " text-white pt-10 text-center", style: { width: "80%", margin: "auto" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("h3", { children: "Gerenciador de arquivos" }),
      "user: ",
      user,
      " url: ",
      url,
...
var import_node7 = require("@remix-run/node"), import_react11 = require("@remix-run/react"), React3 = __toESM(require("react")), import_react_router_dom2 = require("react-router-dom");
var import_react12 = require("react"), import_supabase_js4 = require("@supabase/supabase-js");
...
async function action3({ request }) {
  let userId = await requireUserId(request), formData = await request.formData(), title = formData.get("title"), body = formData.get("body"), image = formData.get("image");
  ...
  let note = await createNote({ title, body, img: image, userId });
  return (0, import_node7.redirect)(`/notes/${note.id}`);
}
function NewNotePage() {
  var _a, _b, _c, _d, _e, _f;
  let actionData = (0, import_react11.useActionData)(), titleRef = React3.useRef(null), bodyRef = React3.useRef(null), imageRef = React3.useRef(null), [file, setfile] = (0, import_react12.useState)([]), [filesData, setFilesData] = (0, import_react12.useState)([]), [db_fileName, db_setFileName] = (0, import_react12.useState)([]), submit = (0, import_react_router_dom2.useSubmit)();
  React3.useEffect(() => {
    var _a2, _b2, _c2, _d2;
    (_a2 = actionData == null ? void 0 : actionData.errors) != null && _a2.title ? (_b2 = titleRef.current) == null || _b2.focus() : (_c2 = actionData == null ? void 0 : actionData.errors) != null && _c2.body && ((_d2 = bodyRef.current) == null || _d2.focus());
  }, [actionData]);
  let handleSubmit = async (e) => {
    e.preventDefault();
    let formData = new FormData();
    formData.set("title", titleRef.current.value), formData.set("body", bodyRef.current.value), formData.set("image", imageRef.current.value), submit(
      formData,
      { method: "post" }
    );
    ...
    let { data, error } = await supabase3.storage.from("files").list("", {
      limit: 100,
      offset: 0,
      sortBy: { column: "name", order: "asc" }
    });
    console.log(data), setFilesData(data);
  }, deleteImage = async (imageName) => {
    if (console.log(imageName), confirm("Confirma exclus\xE3o do arquivo:" + imageName)) {
      let { data, error } = await supabase3.storage.from("files").remove([imageName]);
      console.log(data, error), error ? alert(error) : list_files();
    }
  };
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("label", { className: "flex w-full flex-col gap-1  text-gray-50", children: [
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { children: "Titulo: " }),
          ...
          ((_c = actionData == null ? void 0 : actionData.errors) == null ? void 0 : _c.title) && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "pt-1 text-red-700", id: "title-error", children: actionData.errors.title })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("label", { className: "flex w-full flex-col gap-1  text-gray-50", children: [
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { children: "Texto: " }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
              "textarea",
              {
                ref: bodyRef,
          ...
          ((_f = actionData == null ? void 0 : actionData.errors) == null ? void 0 : _f.body) && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "pt-1 text-red-700", id: "body-error", children: actionData.errors.body })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("label", { className: "flex w-full flex-col gap-1  text-gray-50", children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { children: "Imagem: " }),
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
            "input",
            {
              ref: imageRef,
...
// app/routes/_index.tsx
var import_jsx_runtime9 = require("react/jsx-runtime"), meta = () => [{ title: "Remix Notes" }];
function Index() {
  let user = useOptionalUser();
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("main", { className: "bg-dark relative min-h-screen sm:flex sm:items-center sm:justify-center", children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "relative sm:pb-16 sm:pt-8", children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "mx-auto max-w-7xl sm:px-6 lg:px-8", children: /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "relative shadow-xl sm:overflow-hidden sm:rounded-2xl", children: [
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "absolute inset-0" }),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "relative px-4 pb-8 pt-5 sm:px-6 sm:pb-14 sm:pt-24 lg:px-8 lg:pb-20 lg:pt-15", children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("h3", { className: "text-center text-4xl font-extrabold tracking-tight sm:text-4xl lg:text-4xl", children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: "block uppercase text-yellow-500 drop-shadow-md", children: "MW Notes" }) }),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "mx-auto mt-10 max-w-sm sm:flex sm:max-w-none sm:justify-center", children: user ? /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(
        import_react15.Link,
        {
          to: "/notes",
      ...
      ) : /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "space-y-4 sm:mx-auto sm:inline-grid sm:grid-cols-2 sm:gap-5 sm:space-y-0", children: [
...
var import_node8 = require("@remix-run/node"), import_auth_helpers_remix = require("@supabase/auth-helpers-remix"), loader6 = async ({ request }) => {
  let response = new Response(), supabaseClient = (0, import_auth_helpers_remix.createServerClient)(
    process.env.SUPABASE_URL,
    process.env.SUPABASE_ANON_KEY,
    { request, response }
  ), { data } = await supabaseClient.from("test").select("*");
...
var import_react16 = require("react"), import_supabase_js5 = require("@supabase/supabase-js"), import_uuid3 = require("uuid"), import_jsx_runtime10 = require("react/jsx-runtime"), supabase4 = (0, import_supabase_js5.createClient)("https://lpbqbqcmlspixeiikhcb.supabase.co", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxwYnFicWNtbHNwaXhlaWlraGNiIiwicm9sZSI6ImFub24iLCJpYXQiOjE2ODA2NDU1ODksImV4cCI6MTk5NjIyMTU4OX0.EIGOPYgY4iebJJ1jpJNCoioJZSE9XU83ZPWUhCsgUSk");
function Page() {
  let [file, setfile] = (0, import_react16.useState)([]);
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("form", { onSubmit: async (e) => {
    e.preventDefault();
    let filename = `${(0, import_uuid3.v4)()}-${file.name}`, { data, error } = await supabase4.storage.from("files").upload(filename, file, {
      cacheControl: "3600",
      upsert: !1
    }), filepath = data.path;
  }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("input", { type: "file", name: "image", onChange: (e) => {
      setfile(e.target.files[0]);
    } }),
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("br", {}),
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("button", { type: "submit", children: "Upload image" })
  ] });
}
...
var import_node10 = require("@remix-run/node"), import_react17 = require("@remix-run/react"), React4 = __toESM(require("react"));
...
function LoginPage() {
  ...
  return React4.useEffect(() => {
  ...
  }, [actionData]), /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "flex mt-20 min-h-full flex-col justify-center", children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "mx-auto w-full max-w-md px-8", children: /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(import_react17.Form, { method: "post", className: "space-y-6", children: [
    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "flex w-full justify-center text-white", children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("h3", { children: "Entrar" }) }),
    /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "mt-1", children: [
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
          "input",
          {
            ref: emailRef,
        ...
        ((_b = actionData == null ? void 0 : actionData.errors) == null ? void 0 : _b.email) && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "pt-1 text-red-700", id: "email-error", children: actionData.errors.email })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
      ...
      /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "mt-1", children: [
        ...
        ((_d = actionData == null ? void 0 : actionData.errors) == null ? void 0 : _d.password) && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "pt-1 text-red-700", id: "password-error", children: actionData.errors.password })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("input", { type: "hidden", name: "redirectTo", value: redirectTo }),
    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
      "button",
      {
        type: "submit",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "flex items-center justify-between", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "text-center text-sm text-gray-500", children: [
...
function NotesPage() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "flex h-full min-h-screen flex-col", children: [
    /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("header", { className: "flex pt-6 items-center justify-between bg-slate-800 p-2 text-white no-underline", children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("h5", { className: "text-1xl font-sans	pt-1 pl-2", children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_react18.Link, { to: ".", className: "no-underline text-yellow-500", children: "MW Notes" }) }),
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_react18.Form, { action: "/logout", method: "post", children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
        "button",
        {
          type: "submit",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("main", { className: "flex h-full", children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "h-full w-81 ", children: [
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_react18.Link, { to: "new", className: "no-underline block p-2 ml-7 text-base text-greew-300", children: "+ Nova nota" }),
        data.noteListItems.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("p", { className: "p-2", children: "Nenhuma nota ainda" }) : /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("ol", { children: data.noteListItems.map((note) => /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          import_react18.NavLink,
          {
            className: ({ isActive }) => `block no-underline p-1 text-base ${isActive ? "text-cyan-600" : ""}`,
            to: note.id,
            children: note.title
          }
        ) }, note.id)) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "flex-1 p-6", children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_react18.Outlet, {}) })
    ] })
  ] });
}
...
var import_node12 = require("@remix-run/node"), import_react19 = require("@remix-run/react"), React5 = __toESM(require("react"));
...
function Join() {
  var _a, _b, _c, _d;
  let [searchParams] = (0, import_react19.useSearchParams)(), redirectTo = searchParams.get("redirectTo") ?? void 0, actionData = (0, import_react19.useActionData)(), emailRef = React5.useRef(null), passwordRef = React5.useRef(null);
  return React5.useEffect(() => {
    var _a2, _b2, _c2, _d2;
    (_a2 = actionData == null ? void 0 : actionData.errors) != null && _a2.email ? (_b2 = emailRef.current) == null || _b2.focus() : (_c2 = actionData == null ? void 0 : actionData.errors) != null && _c2.password && ((_d2 = passwordRef.current) == null || _d2.focus());
  }, [actionData]), /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "flex min-h-full flex-col justify-center", children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "mx-auto pt-20 w-full max-w-md px-8", children: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(import_react19.Form, { method: "post", className: "space-y-6", children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "flex w-full justify-center text-white", children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("h3", { children: "Registrar" }) }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "flex items-center justify-center", children: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "text-center text-sm text-gray-500", children: [
      "J\xE1 tem uma conta?",
      " ",
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
        import_react19.Link,
